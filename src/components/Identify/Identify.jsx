        ...
        <Container>
            ...
            <form onSubmit={form.onSubmit((values) => identify(values))}>
                ...
                <Stack my="md" maw={500}>
                    ...
                    <FileInput capture="camera" accept="image/png,image/jpeg" label="Select Image" placeholder="Select Image" icon={<i className="bi bi-camera" />} onChange={setImage} value={image} required accept="image/png,image/jpeg" />
